...
export const rebuilt2026: GameConfig = {
  ...
  actions: [
    ...
    },
    {
      ...
      group: 'HUB',
      accent: 'emerald',
      hint: 'One tap = 5 FUEL. Both HUBs are active during AUTO, so every FUEL counts.',
    },
    {
      kind: 'counter',
      id: 'auto_fuel_missed',
    ...
    // -------------------------------------------------------------- TELEOP
    {
      ...
      group: 'HUB',
      accent: 'emerald',
      hint: 'One tap = 5 FUEL. Use the ±1 trim for a short burst. Active/inactive HUB is resolved later from the timestamp.',
    },
    {
      kind: 'counter',
